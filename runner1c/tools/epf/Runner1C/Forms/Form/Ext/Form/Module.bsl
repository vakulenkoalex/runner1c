...
Функция РеквизитыФормыВСтруктуру()
	...
	ПапкаВыгрузки = Лев(ПапкаВыгрузки, СтрДлина(ПапкаВыгрузки)-1);
	НастройкиВыгрузкиРасширений = Новый Структура("ПапкаВыгрузки, ИмяПапки", ПапкаВыгрузки, ?(ВыгружатьРасширенияВПапкуLib, "lib", "spec"));
	...
	Структура.Вставить("ПапкаВыгрузки",             ПапкаВыгрузки);
	Структура.Вставить("ПапкаВыгрузкиКонфигурации", ПапкаВыгрузки + "\cf");
